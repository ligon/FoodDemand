...
fct = fct.reset_index().set_index('ICRISAT Food Label')[nutrients]
...
C['M 0-3'] = (C['sex']=='M') & (C['age'] <= 3)
C['F 0-3'] = (C['sex']=='F') & (C['age'] <= 3)

C['M 4-8'] = (C['sex']=='M') & (C['age'] > 3) & (C['age'] <= 8)
C['F 4-8'] = (C['sex']=='F') & (C['age'] > 3) & (C['age'] <= 8)

C['M 9-13'] = (C['sex']=='M') & (C['age'] > 8) & (C['age'] <= 13)
C['F 9-13'] = (C['sex']=='F') & (C['age'] > 8) & (C['age'] <= 13)

C['M 14-18'] = (C['sex']=='M') & (C['age'] > 13) & (C['age'] <= 18)
C['F 14-18'] = (C['sex']=='F') & (C['age'] > 13) & (C['age'] <= 18)

C['M 19-30'] = (C['sex']=='M') & (C['age'] > 18) & (C['age'] <= 30)
C['F 19-30'] = (C['sex']=='F') & (C['age'] > 18) & (C['age'] <= 30)

C['M 31-50'] = (C['sex']=='M') & (C['age'] > 30) & (C['age'] <= 50)
C['F 31-50'] = (C['sex']=='F') & (C['age'] > 30) & (C['age'] <= 50)

C['M 51+'] = (C['sex']=='M') & (C['age'] > 50)
C['F 51+'] = (C['sex']=='F') & (C['age'] > 50)
...
** Expenditures vs. \log\lambda
   :PROPERTIES:
   :EXPORT_FILE_NAME: exp_vs_loglambda
   :END:
#+begin_src ipython
%matplotlib inline
import cfe
