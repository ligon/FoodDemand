#+PROPERTY: header-args:jupyter-python :tangle ../../Materials/Project3/estimation_example.py
...
x = read_sheets(Uganda_Data,sheet='Food Expenditures (2019-20)').as_type("float")
x.columns.name = 'j'
